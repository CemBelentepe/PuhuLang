...
public:
    ...
    ArrayList(const ArrayList& other)
        : m_count(other.m_count),
          ...
          m_old_cap(other.m_old_cap),
          m_data(new T[other.m_capacity]),
          resize_factor(other.resize_factor),
          min_cap(other.min_cap)
    {
		memcpy(m_data, other.m_data, sizeof(T) * other.m_capacity);
    }
    ...
    inline T* get_sized(size_t pos, size_t size)
    {
        T* val = new T[size];
        memcpy(val, &m_data[pos], size * sizeof(T));
    }
